...
public class BlockMod {
    ...
    public static final Block TP = new TPBlock();
    public static final Item TP_ITEM = BlockUtils.createBlockItem(TP, ItemGroup.MISC);

    @SubscribeEvent
    public static void registerBlockItems(RegistryEvent.Register<Item> event) {

        event.getRegistry().register(CASTLE_WALL_ITEM);
        event.getRegistry().register(TP_ITEM);
